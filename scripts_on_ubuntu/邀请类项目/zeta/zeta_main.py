...
official_URL = "https://labs.zetachain.com/leaderboard?code=JTimHacag-MHfokMAH_RS"
...
excel_row = 2   #待注册的邮箱. 新的一批号,从第20往后开始
while 1:
    for i in range(excel_row, 308):
        ...
        if "Y" not in str(success_or_fail):
            ...
            try:
                ...
                #==============链接钱包[确保之前已经链接了所有帐号]
                # zeta_connect_wallet(browser, wait)

                #================领水
                active_email_flag = zeta_connect_wallet(browser, wait)
