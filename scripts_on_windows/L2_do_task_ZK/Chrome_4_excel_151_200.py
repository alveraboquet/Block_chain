...
for i in range(3, 52):
    if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+149, "N")) == "1" or str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+149, "N")) == "·1":  # zk 在第7列
        print(f"第{i}，{i+149}个号需要做zk")
        try:
                ##=========== 准备浏览器
            which_chrome = 4
            ...
            if "ZK zigzag" in save_record:
                Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "V", save_record)  #写到账号所在的行，zk_accounts[i] 不用改，就是用 excel 里的行
                Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "P", "哈哈")
            ...
            if "ZK zigzag" in save_record:
                ...
                Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "P", "哈√")
