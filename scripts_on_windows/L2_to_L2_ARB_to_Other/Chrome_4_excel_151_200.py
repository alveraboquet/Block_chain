...
def ARB_orb_zk():
    ...
    if "失败" in info:
        ...
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i + 149, "G", "×")
    else:
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i+149, "G", "·成功")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "J", "1")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "W", info)
...
def ARB_orb_OP():
    ...
    if "失败" in info:
        ...
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i+149, "G", "·成功")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "I", "1")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+149, "W", info)
...
def ARB_lifi_OP():
    ...
    if "失败" in info:
        ...
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i, "G", "成功")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i, "I", "1")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i, "W", info)
...
#user data 5：#excel表格1~200，相差0，chrome 2~201，Chrome5
while True:
    for i in range(4, 52):
        print(f"=======在找号{i+149}")
        #============ 首先确定要转的源是哪个，比如 from 源是 ZK
        if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+149, "D")) == "1":  # ARB 转钱
            if Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+149, "G") != "·成功":
                try:
                    print(f"==========第{i+149}个号需要从 ARB 转到其它 L2=========")
                    ##=============准备浏览器
                    which_chrome = 4
                    ...
                    print(f"{i+149}出错了")
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i+149, "G", "出错了")
                    a = random.randint(10, 20)
                    time_sleep(a, f"++++++++++随机等待时间{a}")
                    try:
                        browser.quit()
