...
# 得从第二个号开始才有钱
for i in range(2, 52):
    if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+49, "H")) == "1" or str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+49, "H")) == "·1":  # OP 所在列
        print(f"=====================第{i}, {i+49}个号需要做 ARB ==================")
        # try:
        ##=========== 准备浏览器

        wait, browser = my_chrome(2)
        ##=========== 预备步骤：切换IP。先打开
        ...
        if "ARB showme" in save_record:
            ...
            Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+49, "O", "√")
