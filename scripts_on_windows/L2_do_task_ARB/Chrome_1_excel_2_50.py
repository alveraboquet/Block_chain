...
for i in range(11, 51):
    if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i, "H")) == "1":  # OP 所在列
        print(f"=====================第{i}个号需要做 ARB ==================")
        # try:
        ##=========== 准备浏览器

        wait, browser = my_chrome(1)
        ##=========== 预备步骤：切换IP。先打开
        ...
        if "ARB showme" in save_record:
            ...
            Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i, "O", "√")
