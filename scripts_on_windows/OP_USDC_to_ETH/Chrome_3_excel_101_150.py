...
while True:
    for i in range(2, 52):
      if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+99, "E")) == "1":   # OP 所在列
          if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+99, "G")) != "·换ETH":
            print(f"=====================第{i}, {i+99}个 OP 号需要 USDC 转 ETH ==================")
            try:
                ##=========== 准备浏览器
                which_chrome = 3
                ...
                if a == 1:
                    ...
                    if "OP zipswap" in save_record:
                        ...
                        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i+99, "G", "换ETH")
                ...
                print("出错了")
                Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "G", "出错了")
