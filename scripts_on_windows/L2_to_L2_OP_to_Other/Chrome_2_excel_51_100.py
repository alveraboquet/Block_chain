...
def OP_orb_ARB():
    ...
    if "失败" in info:
        ...
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+49, "H", "1")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').plain_write(i+49, "G", "·成功")
        Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+49, "W", info)
...
while True:
    for i in range(51, 52):
        ...
        if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+49, "E")) == "1":  # ARB 转钱
