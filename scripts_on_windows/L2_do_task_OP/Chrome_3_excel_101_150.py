...
# 得从第二个号开始才有钱
for i in range(2, 52):
    if str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+99, "M")) == "1" or str(Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').read(i+99, "M")) == "·1":  # OP 所在列
        print(f"=====================第{i}，{i+99}个号需要做 OP ==================")
        try:
            ##=========== 准备浏览器
            which_chrome = 3
            ...
            if a == 1:
                ...
                if "OP showme" in save_record:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "U", "√")
                ...
                if "OP zipswap" in save_record:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "R", "√")
                    time_sleep(2, f"{save_record}，日志写入excel成功")
                else:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    time_sleep(2, f"{save_record}，日志写入excel成功")
                ...
                if "OP clipper" in save_record:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "S", "√")
                    time_sleep(2, f"{save_record}，日志写入excel成功")
                else:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    time_sleep(2, f"{save_record}，日志写入excel成功")
                ...
                if "OP matcha" in save_record:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "T", "√")
                    time_sleep(2, f"{save_record}，日志写入excel成功")
                else:
                    Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "V", save_record)
                    time_sleep(2, f"{save_record}，日志写入excel成功")
            ...
            print(f"----第{i}出错了")
            Do_Excel(r'C:\Users\Terry\PycharmProjects\autopy\L2\eth1000_操作后.xlsx').write(i+99, "K", f"第{i}出错了")
            time_sleep(6, "出错了")
            browser.quit()
            continue
